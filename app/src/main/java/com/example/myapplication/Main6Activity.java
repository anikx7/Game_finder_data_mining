...
public class Main6Activity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        final Vector<String>publisher = new Vector<>();
        final Vector<String>genre = new Vector<>();
        final Vector<String>platform = new Vector<>();
        ...
        final Vector<Integer> top10 = new Vector<>();
        ...
        while (index < 3)
        {
            temp2 = Integer.toString(index+1) + ". " + "Title: " + title.get(top10.get(index))+ ", Publisher: " + publisher.get(top10.get(index))+
        ...
        button1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                int user_choice_index = Integer.parseInt(edit_text.getText().toString());
                String user_choice = "";
                if (user_choice_index == 1)
                {
                    user_choice = title.get(top10.get(0))+genre.get(top10.get(0))+publisher.get(top10.get(0))+platform.get(top10.get(0));
                }
                if (user_choice_index == 2)
                {
                    user_choice = title.get(top10.get(1))+genre.get(top10.get(1))+publisher.get(top10.get(1))+platform.get(top10.get(1));
                }
                if (user_choice_index == 3)
                {
                    user_choice = title.get(top10.get(2))+genre.get(top10.get(2))+publisher.get(top10.get(2))+platform.get(top10.get(2));
                }

                intent.putExtra("userName",user_choice);
